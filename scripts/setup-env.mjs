...
for(const name of ["HRIS_DB_PASSWORD","POSTGRES_ADMIN_PASSWORD","AUTH_SECRET","NEXTAUTH_SECRET","ENCRYPTION_KEY","STORAGE_SIGNING_SECRET","CRON_SECRET","SEED_ADMIN_PASSWORD","SEED_STAFF_PASSWORD"]) {const value=randomBytes(32).toString("hex");text=text.replace(new RegExp("^"+name+"=.*$","m"),name+"="+value);}
