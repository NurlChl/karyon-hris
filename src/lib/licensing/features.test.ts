...
const base: EntitlementSnapshot = { plan: "pro", status: "active", features: ["face.advanced"], expiresAt: "2026-09-21T01:00:00.000Z", graceUntil: "2026-09-22T01:00:00.000Z", installationId: "test", source: "agent" };
